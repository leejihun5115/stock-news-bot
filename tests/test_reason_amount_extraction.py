...
def test_classifier_cog_does_not_filter_evidence_lacking_items(tmp_path):
    """예전엔 근거 없으면 제외했지만, 지금은 절대 제외하면 안 된다."""
    settings = SimpleNamespace(
        news_value_mid=40, news_value_high=70, db_path=tmp_path / "cog_test.sqlite3"
    )
